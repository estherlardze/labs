...
export const multiStepFormData = {
  steps: [
    ...
    },
    {
      id: 3,
      title: "Pick Add-ons",
      description: "Add-ons enhance your experience.",
      addOns: [
        {
          id: "onlineService",
          name: "Online Service",
    ...
    },
    {
      id: 4,
      title: "Finishing Up",
      description: "Review your choices before confirming.",
      summary: {
        selectedPlan: null,
        selectedAddOns: [],
        totalPrice: 0,
